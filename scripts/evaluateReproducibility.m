...
set(gca,'fontsize',12)
saveas(fig,'/cbica/projects/pncNmf/directory_on_cbica/figures/MeanInnerProduct_CT.png');
...
set(gca,'fontsize',12)
saveas(fig2,'/cbica/projects/pncNmf/directory_on_cbica/figures/MedianInnerProduct_CT.png');

fig3 = figure;plot(sortedBasisNum,ARI,'b','LineWidth',2)
xlabel('Number of components','fontsize',12)
ylabel({'Split-sample reproducibility' ;'(Adjusted Rand Index)'},'fontsize',12)
set(gca,'fontsize',12)
saveas(fig3,'/cbica/projects/pncNmf/directory_on_cbica/figures/AdjustedRandIndex_CT.png');
